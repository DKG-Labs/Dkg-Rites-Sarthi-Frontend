...
// Source: PL-60217240 | PL-60217223 | PL-60217250 | PL-60217241 | Northern Railway Annexures A–F | Annexure-B
export const NCRGRSP_CATALOG = {
  ...
  // RT-4865 Alt-8 – 6 mm thick Nylon Cord reinforced GRSP for 1 in 8.5 Turnout with 60E1 rail Alt-8 (Total 216 Pads / 17 Items)
  'RT-4865 Alt-8': [
  ...
  // RT-9842 to RT-9843 – 10 mm NCR GRSP (Total 132 Pads / 22 Items)
  'RT-9842 to RT-9843': [
    { drawingNo: 'RT-9837', qtyPerSet: 4, description: '10 mm NCR GRSP' },
    { drawingNo: 'RT-9852', qtyPerSet: 22, description: '10 mm NCR GRSP' },
    { drawingNo: 'RT-9853', qtyPerSet: 6, description: '10 mm NCR GRSP' },
...
export const normalizeDwg = (dwg) => (dwg || '').replace(/^RDSO[\/-]/i, '').replace(/^(RT|T)[\/-]?/i, '').trim().toUpperCase();

export const resolveNcrgrspCatalogKey = (dwgOrType, candidateDrawings = []) => {
  if (!dwgOrType && (!candidateDrawings || candidateDrawings.length === 0)) {
    return 'RT-9790';
  }

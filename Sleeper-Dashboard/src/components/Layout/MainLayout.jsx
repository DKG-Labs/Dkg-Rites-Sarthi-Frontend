                    ...
                    <div className="header-right">
                        ...
                        <div className="user-info" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '4px', borderRadius: '50px' }}>
                            <div className="user-avatar" style={{
                                ...
                                fontSize: '15px',
                                fontWeight: '700'
                            }}>{user?.userName ? user.userName.substring(0, 2).toUpperCase() : 'U'}</div>
                            <div className="user-meta" style={{ display: 'flex', flexDirection: 'column', paddingRight: '8px' }}>
                                <div className="user-role" style={{ fontSize: '14px', fontWeight: '700', color: '#0f172a', lineHeight: '1.2' }} title={user?.userName}>
                                    {user?.userName || 'User'}
                                </div>
                                <div className="user-email" style={{ fontSize: '12px', color: '#64748b', fontWeight: '500', marginTop: '2px' }}>
                                    Role: Sleeper IE • EMP CODE : {user?.employeeCode || user?.userId || 'N/A'}
                                </div>
                            </div>
                        </div>

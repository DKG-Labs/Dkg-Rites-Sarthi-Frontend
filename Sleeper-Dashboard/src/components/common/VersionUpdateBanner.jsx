...
/**
 * VersionUpdateBanner for Sleeper-Dashboard - Ultra-modern enterprise update modal with SARTHI branding.
 */
      ...
      >
        ...
        <div>
          ...
          <p style={{ margin: 0, fontSize: '13.5px', color: '#64748b', lineHeight: '1.55', fontWeight: 500 }}>
            A newer version of SARTHI Sleeper has been deployed. Please reload to apply the latest features and fixes.
          </p>
        </div>

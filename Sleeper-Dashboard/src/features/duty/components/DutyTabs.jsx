            ...
            {tabs.map((tab) => (
                <div
                    ...
                    style={{
                        ...
                        minHeight: '100px',
                        opacity: tab.isUnderDevelopment ? 0.8 : 1
                    }}
                >
                    <div>
                        <h3 style={{
                        ...
                        <p style={{ fontSize: '10px', color: '#64748b', margin: 0, fontWeight: '500' }}>
                            {tab.isUnderDevelopment ? 'Module integration in progress' : tab.description}
                        </p>
                    </div>
                    ...
                    <div style={{ marginTop: '12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <span style={{
                            fontSize: '10px',
                            fontWeight: '700',
                            color: tab.isUnderDevelopment ? '#92400e' : (activeTab === tab.id ? '#42818c' : '#94a3b8'),
                            textTransform: 'uppercase',
                            letterSpacing: '0.5px'
                        }}>
                            {tab.isUnderDevelopment ? 'Under Development' : (

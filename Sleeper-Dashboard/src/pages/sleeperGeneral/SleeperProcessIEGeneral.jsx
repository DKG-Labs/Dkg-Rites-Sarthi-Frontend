...
import AttendingCallDashboard from './finalInspection/AttendingCallDashboard';
...
const SUB_COLUMNS = [
    ...
    {
        id: 'attending-call',
        label: 'Attending the Call Raised',
        description: 'Manage Call Inspection & IC Issuance',
    ...
    return (
        <div className="ie-general-container">
            ...
            <div className="ie-sub-view-content fade-in">
                ...
                {activeSubView === 'attending-call' && <AttendingCallDashboard />}

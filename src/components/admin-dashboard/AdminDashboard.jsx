...
// Fetch roles for dropdown
    ...
    const handleSaveUser = async (formData) => {
        ...
        try {
            ...
            setSuccessDetails({
                title: 'Success!',
                message: (isRailpadVendor || isSleeperVendor || isErcVendor)
                    ? (selectedItem ? 'Vendor has been updated successfully.' : 'Vendor has been created successfully.')
                    : (selectedItem ? 'User has been updated successfully.' : 'User has been created successfully.'),

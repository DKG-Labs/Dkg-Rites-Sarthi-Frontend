...
const inclusionHeaderRows = [
  [
    ...
    { label: "Inclusion rating (not worse than 2 thin & 2.0 thick A,B,C,D)", colSpan: 8 },
    { label: "Depth of Decarb, not more than d/100 or max 0.25mm which ever less", rowSpan: 3 },

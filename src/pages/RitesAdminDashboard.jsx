    ...
    <div className="rites-admin-container">
      ...
      <div className="rites-admin-grid">
        ...
        >
          ...
          <h2 className="card-title">Inspection Certificates</h2>
          <p className="card-description">
            Upload, search, view, and manage digital Inspection Certificates (ICs) securely.
          </p>
          <div className="card-footer">
            <span className="footer-action-text">Manage Certificates</span>
            <svg viewBox="0 0 24 24" className="footer-arrow-icon" fill="none" stroke="currentColor" strokeWidth="2.5">
              <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
            </svg>
          </div>

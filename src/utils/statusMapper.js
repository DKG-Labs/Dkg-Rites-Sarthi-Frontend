...
export const getDetailedStatus = (systemStatus) => {
  ...
  const mapping = {
    ...
    'SEND_CALL_TO_IBS': { mainStatus: 'Closed', subStatus: 'Sent to IBS' },
    'SENT_TO_IBS': { mainStatus: 'Closed', subStatus: 'Sent to IBS' },
    'CLOSED': { mainStatus: 'Closed', subStatus: 'Sent to IBS' },
